...
public enum TL {
    ...
    PLAYER_POWER_NOLOSS_KOTHZONE("<i>You didn't lose any power since you were in a KoTH zone."),
    ...
    PLAYER_POWER_LOSS_KOTHZONE("<b>The world you are in has power loss normally disabled, but you still lost power since you were in a KoTH.\n<i>Your power is now <h>%d / %d"),
    ...
    KOTH("koth","&eKoTH"),
    KOTH_DESCRIPTION("koth-description", "King of the hill event"),
