...
public class Conf {
    ...
    public static boolean kothDenyBuild = true;
    public static boolean kothPowerLoss = false;
    public static boolean kothBlockCreepers = true;
    public static boolean kothBlockFireballs = true;
    public static boolean kothBlockTNT = true;
    public static boolean kothFriendlyFire = false;
    public static boolean kothDenyEndermanBlocks = false;
